<?php
/*
Template Name: Сохранение номера
*/
get_header(); ?>
<div class="dakr-top-banner">
		<div class="inner">
			<div class="descr">
				<h1>Сохранение номера <br>
					с использованием <br>
					IP-АТС Asterisk</h1>
			</div>
		</div>
	...
	<div class="dakr-block2" id="nextBlock">
		<div class="inner">
			<div class="descr">
				<div class="col-left">
					<p>Еще вчера переезжая в другой офис компании чаще всего теряли номер телефона. Из-за этого приходилось заново печатать визитные карточки, повторно заказывать печатную продукцию с реквизитами компании, печатать заново брошюры и раздаточные материалы. И все потому, что менялся телефонный номер.
					</p>
					<span>И действительно: какой смысл в визитной карточке, с телефонным номером, по которому больше не ответят?</span>
				</div>
				<div class="col-right">
					<img src="/wp-content/themes/voxlink/minimg/savenumber/block2.png" alt="">
				</div>
			</div>
		</div>
	</div>
	<div class="dakr-block3">
		<div class="inner">
			<div class="descr">
				<div class="col-left">
					<p>С использованием <a href="#">IP-телефонии Asterisk</a> и многоканальными телефонными номерами по протоколу SIP этот вопрос решен!
					</p>
					<span><b>Не важно, куда вы переезжаете:</b> будь это соседний дом, район или даже другой город. Приобретенный Вами телефонный номер будет всегда следовать за Вами.</span>
				</div>
				<div class="col-right">
					<img src="/wp-content/themes/voxlink/minimg/savenumber/block3.png" alt="">
				</div>
			</div>
		</div>
	</div>
	<div class="dakr-block4">
		<div class="inner">
			<div class="descr">
				<div class="col-left">
					<p>Использование IP-телефонии дает возможность не сидеть на месте, меняя бизнес-центр на тот, где будут лучшие условия аренды. При этом, переезжая, Вам не придется тратить деньги на услуги переадресации или платить за перенос номера.
					</p>
					<span>Вы просто подключаете оборудование на новом месте и все начинает работать само собой!</span>
				</div>
				<div class="col-right">
					<img src="/wp-content/themes/voxlink/minimg/savenumber/block4.png" alt="">
				</div>
			</div>
		</div>
	</div>
